...
const querytypeoperationbyid = `SELECT 
    -- TYPE OPERATION
    t.idtypeoperation,
    t.codtypeoperation,
    t.idoperation,
...
WHERE t.idtypeoperation = @idtypeoperation`;
...
createligneecriture = ` INSERT INTO EcritureLigneComptable
        (
            ...
            compte,
            idcentreanalytique,
            idcentreanalytiquesecond,
            centreanalytique,
            centreanalytiquesecond,
            idtiers,
            tiers,
            debit,
            credit,
...
queryligneoperationbyidoperationretour = `select 
    l.idligneoperation,
    l.idoperation,
    l.idnature,
    l.idcentre,
...
inner join PlanComptable p on n.idcompte = p.idcompte
left join centreanalytique ca on l.idcentre = ca.idcentreanalytique
where l.idoperation=@idoperation
`;
...
module.exports = {
  ...
  querytypeoperationbyid,
  queryligneoperationbyidoperationretour
};
