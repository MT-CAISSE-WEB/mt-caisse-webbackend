...
module.exports.upsertdevise = asyncHandler (async(req,res, next)=>{
    try {
        const { codedevise, intitule,codeiso,actif,updatedby,createdby } = req.body;
        const updateddevise = await deviseservice.upsertdevise({codedevise,intitule,codeiso,actif,updatedby,createdby});
