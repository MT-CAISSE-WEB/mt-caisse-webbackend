...
const {upload,fixmimetype,} = require("../../../middlewares/upload/pjdemande");
// POUR LES PIÈCES JOINTES

router.post("/:id/demande-pieces-jointes",upload.array("files", parseInt(10)),fixmimetype,controller.uploadFiles,);

router.get("/:id/demande-pieces-jointes", controller.getFiles);
router.delete("/:id/demande-pieces-jointes/:idpiecejointe",controller.deleteFile,);
